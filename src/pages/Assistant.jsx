          ...
          <div className="pt-1 pb-4 pl-2 space-y-4">
            ...
            <AnimatePresence>
              ...
              <motion.div
                ...
                className="w-full">
                  ...
                  <div className={`py-2 flex items-start gap-2 ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                    {message.type === 'assistant' && (
                      <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-1 overflow-hidden border border-border">
                        <img src={getBotLogo()} alt="Bot" className="w-full h-full object-cover" />
                      </div>
                    )}
                    <div className={`rounded-2xl px-3.5 py-2.5 text-sm max-w-[80%] shadow-sm ${
                      message.type === 'user' ?
            ...
            <motion.div
              ...
              className="flex items-center gap-2">
                ...
                <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden border border-border">
                  <img src={getBotLogo()} alt="Bot" className="w-full h-full object-cover" />
                </div>
                <div className="rounded-2xl px-3.5 py-2.5 bg-muted border border-border shadow-sm">
            ...
            <div className="px-2 pt-4 space-y-3">
                ...
                <button
                  ...
                  className="px-3.5 py-2 text-xs bg-card hover:bg-muted border border-border rounded-full text-muted-foreground hover:text-foreground transition-all shadow-sm hover:shadow">
        ...
        <motion.div
          ...
          <div className="w-80 flex flex-col h-full">
            ...
            <div className="p-3 border-b border-border/50">
              ...
              <button
                onClick={createNewChat}
                className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 rounded-xl transition-all duration-200 font-medium">
            ...
            <div className="flex-1 overflow-y-auto px-2 py-2">
              ...
              <button
                 key={chat.id}
                 className={`w-full text-left px-3 py-2.5 rounded-xl mb-1 transition-all duration-200 group relative ${
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}>
                  ...
                  message.type === 'user' ? 'justify-end' : 'justify-start'}`
                    ...
                    {message.type === 'assistant' &&
                  <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden border border-border">
                        <img src={getBotLogo()} alt="Bot" className="w-full h-full object-cover" />
                      </div>
                  }
                    <div
