...
const SUNSET_BOT_LOGO = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68941e9da4c1421699b441d7/3d8f3caac_ChatLogoSunset.png";
      ...
      <div className="block md:hidden h-screen w-full flex flex-col bg-background relative">
        ...
        <div className="flex items-center justify-between px-4 py-3.5 bg-card/98 backdrop-blur-xl border-b border-border/50 shadow-sm flex-shrink-0">
          ...
          <div className="flex items-center gap-2.5 flex-1 justify-center">
            ...
            colorPalette === 'sunset' ?
            <div className="w-8 h-8 rounded-full flex items-center justify-center overflow-hidden">
                <img src={SUNSET_BOT_LOGO} alt="Garden Helper" className="w-full h-full object-cover" />
              </div> :
              ...
              <motion.div
                ...
                className="w-full">
                  ...
                  <div className="py-2 flex items-start gap-2 max-w-[95%]">
                    ...
                    colorPalette === 'sunset' ?
                    <img src={SUNSET_BOT_LOGO} alt="Bot" className="w-full h-full object-cover" /> :
