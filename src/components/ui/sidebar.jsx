...
const SidebarTrigger = React.forwardRef(function SidebarTrigger({ className, onClick, asChild, ...props }, ref) {
  ...
  return (
    <Button
      ...
      onClick={function(event) { if (onClick) onClick(event); toggleSidebar() }}
      asChild={asChild}
      {...props}
    >
      <PanelLeft />
...
const SidebarGroupLabel = React.forwardRef(function SidebarGroupLabel({ className, asChild, ...props }, ref) {
...
const SidebarGroupAction = React.forwardRef(function SidebarGroupAction({ className, asChild, ...props }, ref) {
...
function SidebarMenuButtonInner(props, ref) {
  ...
  if (asChild === undefined) asChild = false
  ...
  return React.createElement(
    ...
    React.createElement(TooltipContent, Object.assign({ side: "right", align: "center", hidden: state !== "collapsed" || isMobile }, tooltipProps))
  )
}

var SidebarMenuButton = React.forwardRef(SidebarMenuButtonInner)
SidebarMenuButton.displayName = "SidebarMenuButton"

const SidebarMenuAction = React.forwardRef(function SidebarMenuAction({ className, asChild, showOnHover, ...props }, ref) {
  const Comp = asChild ? Slot : "button"
  return (
    <Comp
      ref={ref}
...
const SidebarMenuSkeleton = React.forwardRef(function SidebarMenuSkeleton({ className, showIcon, ...props }, ref) {
...
const SidebarMenuSubButton = React.forwardRef(function SidebarMenuSubButton({ asChild, size, isActive, className, ...props }, ref) {
